...
D8-03 thin server/Wear transport   OPAQUE RELAY + HTTPS/OFFLINE CLIENT + BOOTSTRAP/ENROLLMENT RELAY IMPLEMENTED / CREDENTIAL COMPLETION + RECOVERY + REVOCATION + WEAR PENDING
```
